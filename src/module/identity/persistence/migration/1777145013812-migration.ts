...
export class Migration1777145013812 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_privacy_settings" ("id" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "shareName" boolean NOT NULL DEFAULT true, "shareEmail" boolean NOT NULL DEFAULT true, "shareTrainingProgress" boolean NOT NULL DEFAULT false, "sharePastDataWithTrainer" boolean NOT NULL DEFAULT false, "userId" uuid, CONSTRAINT "REL_6c6227fa8fb10ca8cc23ce6939" UNIQUE ("userId"), CONSTRAINT "PK_95fc563e79fedf0b241c0360be0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "trainer_student_relationships" ("id" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "trainerId" uuid NOT NULL, "studentId" uuid NOT NULL, "linkedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_6466809dbe84657bfe692add1ce" UNIQUE ("studentId"), CONSTRAINT "REL_6466809dbe84657bfe692add1c" UNIQUE ("studentId"), CONSTRAINT "PK_7bcad11b188ec201c383fb768d6" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "body_measurements" ("id" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "type" "public"."body_measurements_type_enum" NOT NULL, "value" numeric(6,2) NOT NULL, "measuredAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid NOT NULL, "trainerNote" text, "trainerNoteAt" TIMESTAMP, CONSTRAINT "PK_474282e620ea0cd4fe5d8cbce0f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "weight_logs" ("id" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "weight" numeric(5,2) NOT NULL, "measuredAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid NOT NULL, "trainerNote" text, "trainerNoteAt" TIMESTAMP, CONSTRAINT "PK_96c8f4d341846b34fef50cf4576" PRIMARY KEY ("id"))`);
