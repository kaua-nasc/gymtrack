...
export class Migration1777145016740 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "plan_day_progress" ("id" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "planSubscriptionId" uuid NOT NULL, "dayId" uuid NOT NULL, "status" "public"."plan_day_progress_status_enum" NOT NULL DEFAULT 'IN_PROGRESS', CONSTRAINT "PK_6a1d175ad26bc8e79d4253a447a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "active_workout_sessions" ("id" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" uuid NOT NULL, "planDayProgressId" uuid NOT NULL, "currentExerciseId" uuid, "currentSetIndex" integer NOT NULL DEFAULT '0', "restStartedAt" TIMESTAMP, "adaptiveRestDurationSeconds" integer, "startedAt" TIMESTAMP NOT NULL DEFAULT now(), "lastActiveAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7c5d880eee6814a09a9ea2de6a7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "active_set_logs" ("id" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "sessionId" uuid NOT NULL, "exerciseId" uuid NOT NULL, "setIndex" integer NOT NULL, "reps" integer NOT NULL, "weight" numeric(5,2) NOT NULL, "rpe" integer, CONSTRAINT "PK_cefba1f9f30da66680fe3873282" PRIMARY KEY ("id"))`);
